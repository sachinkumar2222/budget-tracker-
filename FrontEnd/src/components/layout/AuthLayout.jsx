  ...
  return (
    <div className='flex'>
        <div className='w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12'>
            <h2 className='text-lg font-medium text-black'>Budget Tracker</h2>
            {children}
        </div>
...
const StatsInfoCard = ({icon, label, value, color}) =>{
    return (
        <div className='z-1 flex gap-6 bg-white rounded-xl p-4 shadow-md shadow-purple-400/10 border border-gray-200/50'>
            <div className={`w-12 h-12 flex justify-center items-center text-[26px] text-white ${color} rounded-full drop-shadow-xl`}>
                {icon}
            </div>
            <div className=''>
